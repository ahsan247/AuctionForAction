...
<head>
    ...
    <link type="text/css" rel="stylesheet" href="view/clock_assets/flipclock.css"/>
...
<body style="margin-top: 75px">
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-md-7">
                <img class="img-thumbnail" alt="Product Image" style="width: 100%;height: 500px" src="<?php echo $product -> image; ?>" />
            ...
            <div class="col-md-5">
                ...
                <dl class="dl-horizontal">
                    ...
                    <dd>
                        <h4><?php echo $product -> price; ?>&nbsp; BDT</h4>
                    </dd>
                    <dt>
                    ...
                    <?php $con = mysql_connect("localhost", "root", "");
						...
						$id = $_REQUEST['pid'];
						mysql_select_db("AuctionForAction", $con);
                    ...
                    <script type="text/javascript" src="view/clock_assets/flipclock.js"></script>
                    <style text="text/css">
                    ...
                    <dt>
                        <form method="post">
                            <input name="bAmount" type="text" required class="form-control" placeholder="Bidding Amount">
                    </dt>
                    </dt>
  ...
  <strong>Well done!</strong> You are the highest bidder now! If you remain in the top position, admin will contact you.
</div>';
                        ...
                        <h4>
                            <?php
								...
								if ($result -> num_rows > 0) {
									echo '
							<table class="table table-striped table-bordered table-hover table-condensed" align="center" style="width:100%; border-radius: 10px;margin-left: -140px;margin-top: 50px;">
                            <thead bgcolor="black">
								<tr>
									<th scope="col" style="color:white;">Rank</th>
									<th scope="col" style="color:white;">Bidder Name</th>
									<th scope="col" style="color:white;">Bid Price</th>
								</tr></thead>';
